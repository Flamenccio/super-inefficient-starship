...
public class AimAssist : MonoBehaviour
{
    ...
    private AllAngle angleRayB = new AllAngle();
    private AllAngle angleRayC = new AllAngle();
    ...
    {
        AllAngle offsetH = new AllAngle(); // offset high
        AllAngle offsetL = new AllAngle(); // offset low 
