...
namespace Enemy
{
    public class ImpSpawner : EnemyBase, IEnemy
    {
        ...
        private float spawnTime = 3.0f; // the amount of time in seconds between each spawn tick.
        private float timer = 0f;
        private int spawnCount = 4; // the number of imps to spawn.
        private int impsSpawned = 0;
        private const int ANIM_FRAME_RATE = 12;
        private int ANIM_TOTAL_FRAMES = 6;
        ...
        protected override void OnSpawn()
        {
            ...
            float animTimeScale = spawnTime / baseAnimTime;
