...
namespace Flamenccio.Attack.Enemy
{
    public class Bomb : EnemyBulletNormal
    {
        ...
        protected override void Trigger(Collider2D collider)
        {
            ...
            Instantiate(explosionHitbox, transform.position, Quaternion.identity).GetComponent<Hitbox>().EditProperties(0f, 2f, playerDamage, Hitbox.AttackType.Neutral, knockbackMultiplier); // spawn the actual hitbox
